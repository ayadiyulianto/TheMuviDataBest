...
object DataDummy {
    ...
    fun generateDummyMovieDetailResponse(): List<MovieDetailResponse> {
        val movieDetailResponse = ArrayList<MovieDetailResponse>()
    ...
    fun generateDummyTvShowDetailResponse(): List<TvShowDetailResponse> {
        val showDetailResponse = ArrayList<TvShowDetailResponse>()
